...
#define NEGDIVMOD(n, d, m) { \
	...
	int32_t encodeBocu1(int32_t *pPrev, int32_t c);

	int32_t decodeBocu1(Bocu1Rx *pRx, uint8_t b);

	int32_t writeString(const wchar_t *s, int32_t length, uint8_t *p);

	int32_t readString(const uint8_t *p, int32_t length, wchar_t *s);
}
#endif
